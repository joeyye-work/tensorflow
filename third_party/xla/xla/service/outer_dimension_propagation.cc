...
static absl::optional<int64_t> ComputeMultiplierForUserScalar(HloInstruction* operand,
  ...
  switch (user->opcode()) {
    ...
    // --------------------------------------------
    // Group 3: Strict Identity / PassThrough on Operand 0
    // --------------------------------------------
    ...
    case HloOpcode::kGetTupleElement:
      return flag_unsupport;
    // --------------------------------------------
    // Group 8: Token/SideEffect (Mostly unreachable due to early checks)
    // --------------------------------------------
    ...
    case HloOpcode::kCollectivePermuteDone:
      ...
      // is_tuple checks or rnank checks earlier.
      return operand_mul_val;
  }
